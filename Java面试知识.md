...
ArrayList底层为数组队列，与Java普通的数组相比，其可以动态变化，容量动态增长。添加元素前，会使用ensureCapacity操作来增加ArrayList实例的容量。这样减少递增式再分配的数量

ArrayList继承于AbstractList，实现List，RandomAccess，Cloneable，Serializable接口
...
![](assets/ArrayList源码1.png)

![](assets/ArrayList源码2.png)
...
实际初始化时ArrayList是一个空数组的，只要当添加元素时，才会去扩容

补充：JDK6 new 无参构造的 `ArrayList` 对象时，直接创建了长度是 10 的 `Object[]` 数组 `elementData` 

![](assets/ArrayList源码3.png)
