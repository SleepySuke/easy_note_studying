...
![](assets/1766224747577.png)

请求体数据的时候，数据发的是什么就写什么

wd = test就写wd = test

![](assets/1766225470559.png)

#### 结果树查询

![](assets/1766225520728.png)

结果树乱码问题

![](assets/1766225569070.png)

结果树查询中的最外层http请求与多个http请求，发送的请求与最后一个http请求相对应http-1，配置的请求看第一个http-0

![](assets/1766227250001.png)

Jemter可以自动处理/判断响应状态码

### 参数化

![](assets/1766225685913.png)

![](assets/1766225730218.png)

**用户定义变量**

![](assets/1766225791508.png)

![](assets/1766225886535.png)

**用户参数**

![](assets/1766225953996.png)

针对不同用户时使用用户参数

**CSV数据文件**

![](assets/1766226147109.png)

**函数参数化**

_counter计数函数

![](assets/1766226435751.png)

![](assets/1766226696475.png)

函数不适用于需要特定数据的业务之中

###核心组件

![](assets/1766226933466.png)

![](assets/1766226980461.png)

### Jemter断言

![](assets/1766672972390.png)

### 响应断言

![](assets/1766673016573.png)

![](assets/1766673077416.png)

![](assets/1766673227874.png)

![](assets/1766673296363.png)

![](assets/1766673341416.png)

默认是且的关系

### JSON断言

![](assets/1766673667654.png)

### 断言持续时间

![](assets/1766673946439.png)

![](assets/1766674275810.png)

此时如果预期响应码为4xx/5xx，在断言测试字段中使用忽略

### JMeter关联

![](assets/1766674437640.png)

![](assets/1766674454461.png)

XPath提取器针对html格式

正则表达式可以针对任意形式的响应数据进行提取

**正则表达式**

![](assets/1767534579019.png)

![](assets/1767535054200.png)

DebugSampler具有调试功能，能够看到所有的请求数据

![](assets/1767536372262.png)

**Xpath提取器**

![](assets/1767536410284.png)

![](assets/1767536509062.png)

**JSON提取器**

![](assets/1767536746323.png)

### JMeter属性

![](assets/1767540804559.png)

![](assets/1767540881983.png)

![](assets/1767541115927.png)

跨线程组的时候便需要用到JMeter属性，设置全局变量

### JMeter脚本录制

![](assets/1767541217284.png)

![](assets/1767541248573.png)

跟抓包差不多，中间截取流量，操作类似burpsuite

![](assets/1767541355396.png)

![](assets/1767541383568.png)

![](assets/1767541581142.png)
